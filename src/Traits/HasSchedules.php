...
trait HasSchedules
{
    ...
    {
        return $this->hasMany(config('billing.models.plan_subscription_schedule'), 'subscription_id', 'id');
    }
     ...
     *
     * @return HasSchedules|\Bkfdev\Billing\Models\PlanSubscription
     */
    ...
    public function getLatestSchedule(?Carbon $date = null)
    {
        ...
        return app(config('billing.models.plan_subscription_schedule'))
            ->pending($date)
