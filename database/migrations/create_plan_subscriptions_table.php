...
return new class extends Migration {
    ...
    {
        Schema::create(config('billing.tables.plan_subscriptions'), function (Blueprint $table) {
            $table->increments('id');
            $table->string('tag');
            ...
            $table->foreign('plan_id')->references('id')->on(config('billing.tables.plans'))
    ...
    {
        Schema::dropIfExists(config('billing.tables.plan_subscriptions'));
    }
};
